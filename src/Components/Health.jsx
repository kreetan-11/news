...
export default function Health() {
    ...
    function getHealth(){
        axios.get(`https://newsapi.org/v2/everything?q=health&apiKey=e3fd36ba7f564e6897a2ae73c4beaa4d`)
 ...
 <div className="py-16 bg-gradient-to-br from-green-50 to-cyan-100">  
  <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
    <div className="mb-12 space-y-2 text-center">
      ...
      <h2 className="text-2xl text-cyan-900 font-bold md:text-4xl">Health-news</h2>
